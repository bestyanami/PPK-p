            ...
            write_json(
                ...
                "PKObjResultsFolder\Result_20250313180356_result.json", 
                auto_unbox = TRUE
            )
            quit(status=1)
            }
            ...
            # 保存模型拟合结果
            saveRDS(result, "PKObjResultsFolder\Result_20250313180356.ressum.rds")
            ...
            write_json(list(
                ...
                metrics = metrics
            ), "PKObjResultsFolder\Result_20250313180356_result.json", auto_unbox = TRUE)
